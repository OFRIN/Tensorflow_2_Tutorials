...
def custom_split(dataset, the_number_of_section):
    size_of_section = len(dataset) // the_number_of_section

    split_dataset = []

    for i in range(the_number_of_section - 1):
        split_dataset.append(dataset[:size_of_section])
        dataset = dataset[size_of_section:]
